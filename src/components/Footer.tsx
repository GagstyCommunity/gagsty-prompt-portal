      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="inline-block p-3 rounded-xl bg-gradient-to-r from-purple-600 to-emerald-600 mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link to="/submit" className="hover:text-purple-400 transition-colors">Submit Game</Link></li>
              <li><Link to="/battle" className="hover:text-purple-400 transition-colors">Prompt Battle</Link></li>
              <li><Link to="/events" className="hover:text-purple-400 transition-colors">Earn</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link to="/codex" className="hover:text-purple-400 transition-colors">Codex</Link></li>
              <li><Link to="/jobs" className="hover:text-purple-400 transition-colors">Gigs</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 Gagsty. All rights reserved. Launching August 30, 2025.
          </p>
